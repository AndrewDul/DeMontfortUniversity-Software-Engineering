...
public class NameRegisterIO implements Iterable<Name> {
	...
	public void readNameListFromFile() throws IOException, ClassNotFoundException {
		...
		var ois = new ObjectInputStream(new FileInputStream("nameListObj.dat"));
	...
	public void readAndAddNameListFromFile() {
		...
		try (var ois = new ObjectInputStream(new FileInputStream("nameListObj.dat"))){
	...
	public void readAndAddNamesFromFile() {
		...
		try (var ois = new ObjectInputStream(new FileInputStream("nameObjs.dat"))) {
